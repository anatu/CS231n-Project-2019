'''
Resize script from Thung and Yang's trashnet (https://github.com/garythung/trashnet)
Accepts images from an input folder, resizes them to dimensions specified in trashnet constants.py,
and outputs them to a destination folder
in subfolders by class 
'''
...
def main():
	prepath = os.path.join("../datasets/trashnet", 'newImages')
	...
	#COMPOST
	fileWalk(trashDir, os.path.join(destPath, 'compost'))  
